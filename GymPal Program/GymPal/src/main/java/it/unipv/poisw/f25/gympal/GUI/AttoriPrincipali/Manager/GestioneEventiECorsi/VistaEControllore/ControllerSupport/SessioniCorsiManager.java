...
public class SessioniCorsiManager {
    ...
    public void onCancellaSessione() {
        ...
        ///////////////////////////////////////////////////////////////
        /* Rescissione iscrizioni (dei clienti) a corso, previa eliminazione
         * del corso stesso.*/
        List<Cliente> clientiIscrittiASessione = calendarioService.findClientiBySessione(id);
        
        if(clientiIscrittiASessione != null && !clientiIscrittiASessione.isEmpty()) {
        	
        	for(Cliente cliente : clientiIscrittiASessione) {
        		
        		calendarioService.annullaPartecipazione(cliente.getCf(), id);

...
import it.unipv.poisw.f25.gympal.GUI.AttoriPrincipali.Manager.GestioneEventiECorsi.VistaEControllore.ControllerSupport.EventiGenericiManager;
...
public class EventiECorsiController {
	...
	private void clearIfClickedOutside(JTable table, MouseEvent e) {
	    ...
	    Point point = SwingUtilities.convertPoint((Component) e.getSource(), 
	    													  e.getPoint(), table);
	    if (point.x < 0 || point.y < 0 || point.x >= table.getWidth() 

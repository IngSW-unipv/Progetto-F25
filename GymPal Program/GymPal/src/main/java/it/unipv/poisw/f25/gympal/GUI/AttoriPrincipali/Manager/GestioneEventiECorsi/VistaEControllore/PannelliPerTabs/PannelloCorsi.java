package it.unipv.poisw.f25.gympal.GUI.AttoriPrincipali.Manager.GestioneEventiECorsi.VistaEControllore.PannelliPerTabs;
...
public class PannelloCorsi extends JPanel implements TabellaSelezionabile{
    ...
    @Override
    public JTable getTabella() {return sessioniTable;}

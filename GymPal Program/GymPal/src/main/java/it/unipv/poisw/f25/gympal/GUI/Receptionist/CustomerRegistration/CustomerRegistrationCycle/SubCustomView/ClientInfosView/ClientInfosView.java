...
public class ClientInfosView extends JPanel implements IClientInfosView{
   ...
   //----------------------------------------------------------------
    ...
    //----------------------------------------------------------------
    @Override public void addDateSpinnerListener(ChangeListener l) { dateSpinner.addChangeListener(l); }
    ...
    @Override public JPanel getAvantiIndietroPanel() { return navigationPanel; }

...
public interface IRegexExpression {
	 ...
	 * 
	 * "[a-zA-Z]{2,6}" ---> il dominio deve essere composto da almeno due lettere e lungo
	 * 						al massimo 6, vincolo imposto da "{2, 6}"
	 * 
	 ...
	 * 
	 * "(?!-)" ---> il dominio non può iniziare con "-".
	 * 
	 * "(?!.*--)" ---> non ammette doppio trattino consecutivo.
	 * 
	 * "[a-zA-Z0-9-]+(\\.[a-zA-Z0-9-]+)" ---> più "label" separate da punti, ogni label 
	 * 										  fatta di lettere, numeri o trattini
	 * 
	 *  Non sono consentiti underscore nel dominio.*/

package it.unipv.poisw.f25.gympal.GUI.AttoriPrincipali.Receptionist.GestioneCalendario.CalendarioInterattivo.ManipolazioneDati.JDialogFissaAppuntamento;
...
public class FissaAppuntamentoDialog extends JDialog {
    ...
    private void inizializzaDialog(List<String> staffIdOptions) {
        ...
        /* La sintassi 'this::handleConferma' significa che il metodo 
         * 'hnadleConferma' è passato come callback per l'azione che si verifica
         * quando 'confermaBtn' è premuto.
         * 
         * Il '::' è una versione più concisa della creazione di un oggetto anonimo
         * (una classe che implementa l'interfaccia 'ActionListener').
         * 
         * In alternativa si potrebbe ricorrere alla sintassi:
         * 
         * confermaBtn.addActionListener(e -> handleConferma(e));
         */
    ...
    /* In essenza, questo è un listener, che in quanto tale deve rispettare la firma:
     * 
     * void actionPerformed(ActionEvent e)
     * 
     * Questo vale anche se 'e' non è usato nel corpo del metodo.*/
    private void handleConferma(ActionEvent e) {
        ...
        if (cf == null || cf.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Inserire il codice fiscale del "
            								  + "cliente.");
            return;
        }
        ...
        if (getData() == null) {
            ...
            JOptionPane.showMessageDialog(this, "Inserire una data valida "
            								  + "(yyyy-MM-dd).");
            return;
